...
| `@sixb/connector-microsoft` | `microsoft(...)` | Microsoft Graph (SharePoint files, Outlook mail, attachments and delta sync) | — |
...
| `@sixb/connector-quickbooks` | `quickbooks(...)` | QuickBooks Online reference/transaction reads and CDC (managed OAuth) | Verified CloudEvents |

...
You'll need [Bun 1.4.2 or later](https://bun.sh/docs/installation).
...
Sixb core is currently `0.1.10`. Packages are versioned independently and publish only when they change.

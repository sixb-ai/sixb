        ...
        <Card className="p-0">
          <CardContent className="p-5">
            ...
            <p className="mt-2 text-xs text-muted-foreground">
              Phase <span className="font-mono text-foreground">{run.error.phase}</span>
            </p>
            {run.error.details !== undefined || run.error.causeChain !== undefined ? (
              <div className="mt-4">
                <DataPanel
                  label="Diagnostics"
                  value={{
                    ...(run.error.details !== undefined ? { details: run.error.details } : {}),
                    ...(run.error.causeChain !== undefined
                      ? { causeChain: run.error.causeChain }
                      : {}),
                  }}
                />
              </div>

...
const writebackPhase: FailedWriteback["error"]["phase"] = "writeback"
const effectsPhase: FailedEffects["error"]["phase"] = "effects"

// @ts-expect-error a writeback record cannot carry an effects failure
const unrelatedWritebackPhase: FailedWriteback["error"]["phase"] = "effects"
// @ts-expect-error an effects record cannot carry a writeback failure
const unrelatedEffectsPhase: FailedEffects["error"]["phase"] = "writeback"

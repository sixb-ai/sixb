/**
 * Static method manifests and composite façade factories for {@link InMemoryStorage}.
 *
...
export function createAgentStorageFacade(
...
export function createWorkflowRunStorageFacade(

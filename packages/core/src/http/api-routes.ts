...
export const SIXB_API_ROUTES: readonly SixbApiRoute[] = [
  ...
  // the gateway already hands routes an execution SDK, so flipping `agentApi` later needs no
  ...
  },
  {
    ...
    method: "GET",
    path: "/api/action-runs/:runId/files/content",
    accessToken: true,
    agentApi: true,
  },
  {
  ...
  },
  {
    ...
    method: "GET",
    path: "/api/workflow-runs/:runId/nodes/:nodeKey/files/content",
    accessToken: true,
    agentApi: false,
  },
  {
  ...
  },
  {
    ...
    method: "GET",
    path: "/api/ai/accounting/overview",
    accessToken: true,
    agentApi: false,
  },
  {

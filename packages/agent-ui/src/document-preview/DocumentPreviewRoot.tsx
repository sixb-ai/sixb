...
export function DocumentPreviewRoot({
  ...
  const context = useMemo<DocumentPreviewContextValue>(
    ...
    [canPreview, activeDocument?.id, closeDocument, openDocument, viewerVisible]
  )
  const viewerProps = useMemo<DocumentViewerProps>(
    ...
    [documentPreviewRenderers, closeDocument, dismissViewer, idPrefix, selectDocument, visibleState]
  )

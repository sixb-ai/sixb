...
describe("AgentWorker", () => {
  ...
  test.each([
    false,
    true,
  ])("saves a persistent workspace before finalizing and resumes without rerunning setup (auth=%s)", async (withAuth) => {
    ...
    const model = answerModel(undefined, (system) => prompts.push(system ?? ""))

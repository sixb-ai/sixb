...
describe("agent system prompt", () => {
  test("renders the canonical conversation mode", () => {
    ...
    expect(prompt).toContain("Keep the user oriented during multi-step or longer work")
    expect(prompt).toContain("when you discover something important")
    expect(prompt).toContain("Do not narrate every step")
    expect(prompt).toContain("announce actions that finish immediately")
    expect(prompt).toContain("Keep progress updates short, factual, and useful")

...
import agentThreadWorkspacesSql from "./migrations/036-agent-thread-workspaces.sql" with {
  type: "text",
}
import agentWorkspaceLifecycleSql from "./migrations/037-agent-workspace-lifecycle.sql" with {
  type: "text",
}
...
export const sqliteStorageMigrations = defineMigrations({
  ...
  steps: [
    ...
    sqliteSql("036-agent-thread-workspaces", agentThreadWorkspacesSql),
    sqliteSql("037-agent-workspace-lifecycle", agentWorkspaceLifecycleSql),
  ],
})

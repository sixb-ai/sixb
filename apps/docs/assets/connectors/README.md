...
Logos identify the services supported by the connectors; the marks belong to their respective owners.
...
- `mercury.svg`: https://mercury.com/icon.svg?9c0dadf0c8dee356
...
Storage provider artwork:
- [PostgreSQL elephant](https://www.postgresql.org/media/img/about/press/elephant.png)
- [SQLite symbol, via Devicon](https://github.com/devicons/devicon/blob/master/icons/sqlite/sqlite-original.svg) ([MIT](https://github.com/devicons/devicon/blob/master/LICENSE))
